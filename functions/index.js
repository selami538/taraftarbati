export async function onRequest(context) {
  ...
  const apiUrl = "https://paneltaraftarium.corepanel.pro/api/verirepo.php";
...
<div class="menu-item" data-matchfilter="Futbol,Futbol TR,Football, FutboI" title="Futbol">
  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 32 32" fill="#ffffff">
   ...
   <div class="menu-item" data-matchfilter="Basketbol, Basketbol TR" title="Basketbol">
   <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 32 32" fill="#ffffff">
...
<!-- JS -->
<script>
  fetch('https://trkey.sbs/load/matches.php')
    ...
    .then(data => {
      ...
      filterMatches("Futbol,Futbol TR,Football, FutboI, Basketbol TR");
    })
                ...
                <div class="match-cover" style="width: 100%;">
                  <div class="match-tab-box" style="display: block; width: 100%;">
                    <div id="channels-content" style="width: 100%;">
                      <script>
                        fetch('https://trkey.sbs/load/channels.php')
                          .then(response => response.text())
                          .then(data => {
