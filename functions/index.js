export async function onRequest(context) {
  ...
  const apiUrl = "https://panelt24.matchkey.sbs/api/verirepo.php";
...
${reklam1 
  ? `<div style="margin: 10px; text-align: center;">
      ${hrefreklam1 
        ? `<a href="${hrefreklam1}" target="_blank"><img class="ads-img" src="${reklam1}" width="100%" height="30px"/></a>` 
...
<div class="menu-item" data-matchfilter="Futbol,Futbol TR,Football" title="Futbol">
...
<script>
  fetch('https://matchkey.sbs/load/matches.php')
    ...
    .then(data => {
      ...
      filterMatches("Futbol,Futbol TR,Football");
    })
